...
toolboxBtn.addEventListener('click', () => {
    const showing = toolboxPanel.style.display === 'block';
    toolboxPanel.style.display = showing ? 'none' : 'block';
    if (!showing) { toolboxSearch.value = ''; closeToolboxDetail(); renderToolbox(''); }
});
closeToolboxBtn.addEventListener('click', () => { toolboxPanel.style.display = 'none'; });
